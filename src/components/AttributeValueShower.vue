<template>
    <div class="containerTextShower ripple" @click="copyContent()" >
        <p id="title">{{ this.title }}</p>
        <div v-if="this.is_pssw != 'true'">
            <p>{{ this.value }}</p>
        </div>
                ...
                <i v-if="this.display_type == 'password'" @click="switchPasswordVisability()">
                    ...
                    >
                        <g opacity="0.59" clip-path="url(#clip0_8_25)">
                            <path
                                d="M7.39575 14.8691L5.86704 14.459L6.49008 12.1323C5.55747 11.7883 4.69072 11.2871 3.92746 10.6503L2.223 12.3555L1.10279 11.2353L2.80804 9.53088C1.84543 8.37802 1.19865 6.99498 0.931 5.51713L2.489 5.23292C3.08987 8.5595 6.00004 11.0833 9.5 11.0833C12.9992 11.0833 15.9101 8.5595 16.511 5.23292L18.069 5.51633C17.8017 6.99439 17.1552 8.37771 16.1927 9.53088L17.8972 11.2353L16.777 12.3555L15.0725 10.6503C14.3093 11.2871 13.4425 11.7883 12.5099 12.1323L13.133 14.4598L11.6042 14.8691L10.9804 12.5416C10.0006 12.7095 8.99939 12.7095 8.01958 12.5416L7.39575 14.8691Z"
                                fill="white"
                            />
                        </g>
                    </svg>
