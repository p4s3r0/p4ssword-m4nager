<template>
    <div id="mainPassword">
        ...
        <div id="posIcons">
                <svg @click="copyUsername" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg @click="copyPassword" id="lockIcon" width="30" height="30" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
