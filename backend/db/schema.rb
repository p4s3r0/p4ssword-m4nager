...
ActiveRecord::Schema[8.1].define(version: 2026_06_27_163343) do
  ...
  create_table "tfas", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.bigint "user_id", null: false
    t.index ["user_id"], name: "index_tfas_on_user_id"
  end
